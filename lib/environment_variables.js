...
/**
 * Defines if the current ecosystem is in MULTINODE or not, default False.
 * @type {string}
 */
const Env_IsMultinode = "IsMultinode"
module.exports.Env_IsMultinode = Env_IsMultinode

/**
 * Defines the default multinode status, defaults to 'false'. Can be overriden in the cypress.json.
 * @type {string}
 */
module.exports.Default_IsMultinode = "false"

/**
 * Returns the currently configured user group that have administrative privileges in the ces.
 * @returns {boolean}
 */
module.exports.IsMultinode = function () {
    return Cypress.env(Env_IsMultinode) === "true"
}
