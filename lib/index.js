...
module.exports.configure = (config) => {
    ...
    // Set the Multinode-State
    if (!config.env.IsMultinode) {
        console.log("Set IsMultinode to default: " + env.Default_IsMultinode)
        config.env.IsMultinode = env.Default_IsMultinode
    }
