...
module.exports.GetDoguName = function () {
    return Cypress.expose(Env_DoguName)
}
...
module.exports.GetMaxRetryCount = function () {
    return Cypress.expose(Env_MaxLoginRetries)
}
...
module.exports.GetAdminUsername = function () {
    return cy.env([Env_AdminUsername]).then((vals) => vals[Env_AdminUsername])
}
...
module.exports.GetAdminPassword = function () {
    return cy.env([Env_AdminPassword]).then((vals) => vals[Env_AdminPassword])
}

/**
 * Returns both currently configured ces admin credentials in one round-trip.
 * @returns {Cypress.Chainable<{AdminUsername: String, AdminPassword: String}>}
 */
module.exports.GetAdminCredentials = function () {
    return cy.env([Env_AdminUsername, Env_AdminPassword])
}
...
module.exports.GetAdminGroup = function () {
    return Cypress.expose(Env_AdminGroup)
}
